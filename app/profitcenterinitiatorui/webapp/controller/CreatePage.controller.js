      ...
      "mdg.profitcenter.ui.profitcenterinitiatorui.controller.CreatePage",
      {
        ...
        addProfitCenterobj: async function () {
          ...
          let initialisePCModel = {
            ...
            controllingarea: "",
            name: "",
            analysisPeriodValidFrom: "",
            analysisPeriodValidTo: "",
            longText: "",
            personresponsible: "",
            profitCentGroup: "",
            segment: "",
        ...
        handleMessagePopoverPressFrag: function (oEvent) {
          this.oMessagePopoverFrag.toggle(oEvent.getSource());
        },
        ...
        onInputValueChange(oEvtControl) {
          let sNewValue = oEvtControl.getParameter('newValue');
          let oPCModel = this.getView().getModel("oPCModel");
          if (oPCModel.getProperty("/profitcenter") !== '' && oPCModel.getProperty("/controllingarea") !== '') {
            oPCModel.setProperty("/enableTabs", true);
          }
        },
